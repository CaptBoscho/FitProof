...
class MediaPipePoseModule(private val reactContext: ReactApplicationContext) : ReactContextBaseJavaModule(reactContext) {
    ...
    private fun classifyPose(landmarks: List<com.google.mediapipe.tasks.vision.poselandmarker.PoseLandmark>): Pair<String, Float> {
    ...
    private fun classifyPushupPose(
        leftShoulder: com.google.mediapipe.tasks.vision.poselandmarker.PoseLandmark,
        rightShoulder: com.google.mediapipe.tasks.vision.poselandmarker.PoseLandmark,
        leftElbow: com.google.mediapipe.tasks.vision.poselandmarker.PoseLandmark,
        rightElbow: com.google.mediapipe.tasks.vision.poselandmarker.PoseLandmark,
        leftWrist: com.google.mediapipe.tasks.vision.poselandmarker.PoseLandmark,
        rightWrist: com.google.mediapipe.tasks.vision.poselandmarker.PoseLandmark
    ): Pair<String, Float> {
    ...
    private fun classifySquatPose(
        leftHip: com.google.mediapipe.tasks.vision.poselandmarker.PoseLandmark,
        rightHip: com.google.mediapipe.tasks.vision.poselandmarker.PoseLandmark,
        leftKnee: com.google.mediapipe.tasks.vision.poselandmarker.PoseLandmark,
        rightKnee: com.google.mediapipe.tasks.vision.poselandmarker.PoseLandmark
    ): Pair<String, Float> {
